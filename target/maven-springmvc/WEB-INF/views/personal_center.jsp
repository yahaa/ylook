    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid margin-bottom-10">
            <div class="span3 bg-light">
                ...
                <div class="headline"><h3>个人动向</h3></div>
                <ul class="nav nav-sidebar">
                    <li class="disabled"><a href="#">正在进行</a></li>
                </ul>
                <ul class="nav nav-sidebar">
                    <li><a href="#">帮助</a></li>
                    <li><a href="#">被帮助</a></li>
                ...
                <ul class="nav nav-sidebar">
                    <li class="disabled"><a href="#">历史纪录</a></li>
                </ul>
                <ul class="nav nav-sidebar">
                    <li><a href="#">帮助过</a></li>
                    <li><a href="#">被帮助过</a></li>
                ...
                <ul class="nav nav-sidebar">
                    <li class="disabled"><a href="#">我的动向</a></li>
                </ul>
                <ul class="nav nav-sidebar">
            ...
            <div class="span9 bg-light">
                <div class="booking-blocks">
                    <div style="overflow:hidden;">
                        <h2><a href="details.html">标题</a></h2>
...
<div class="copyright">
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span4">
                <a href="index.html"><img id="logo-footer" src="../statics/img/logo2-default.png" class="pull-right"
                                          alt=""/></a>
            </div>
        </div>
    </div>

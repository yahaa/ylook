...
<div class="container">
    <div class="row">
        <div class="navbar  navbar-fixed-top nav-color" style="background-color: #f8f8f8;border-color: #e7e7e7;">
            <div class="nav-center">
                ...
                <div class="col-md-2">
                    <div class="search-icon" style="color: rgba(7, 0, 0, 0.88)">
